...
dataSchema.plugin(autoIncrement.plugin,{
  model: "tb_courses", // collection or table name in which you want to apply auto increment
  field: "courseid", // field of model which you want to auto increment
  startAt: 1, // start your auto increment value from 1
  incrementBy: 1, // incremented by 1
}
);

module.exports = mongoose.model('tb_courses', dataSchema) 